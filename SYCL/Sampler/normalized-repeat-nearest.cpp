...
// Four pixels at low-boundary locations, sample: Normalized + Repeat + Nearest
std::vector<pixelT> ref_boundary = {
    {1, 2, 3, 4}, {49, 48, 47, 46}, {59, 58, 57, 56}, {11, 12, 13, 14}};
// Four pixels above right bound, sample: Normalized + Repeat + Nearest
std::vector<pixelT> ref_right = {
    {1, 2, 3, 4}, {49, 48, 47, 46}, {59, 58, 57, 56}, {11, 12, 13, 14}};
// Four pixels below left bound. sample: Normalized + Repeat + Nearest
